...
{
    internal class GymContext<TEntity> : DbContext, IBaseContext<TEntity> where TEntity : class
    {
        public DbSet<TEntity> Entities { get; set; }

        public GymContext(string connectionName = "N_Base") : base("Name=" + connectionName)
        {
            Database.SetInitializer(new CreateDatabaseIfNotExists<GymContext<TEntity>>());
